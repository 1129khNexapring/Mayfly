...
#mypage-left-side{
	...
	#reviewWriteTable td:nth-child(odd) {
		background: #fff5ee;
	}
	#reviewWriteTableDiv {
		margin-right: 300px;
...
<body id="page-top">
	...
	<form action="/review/register.mayfly" method="GET" enctype="multipart/form-data">
		<div id="reviewWriteTableDiv">
		<table align="center" border="1"  id="reviewWriteTable" width="800">
			<tr>
				<td align="center">예약번호</td>
				<td><input type="text" size="87" name="bookingNo"></td>
			</tr>
			<tr>
				<td align="center">컨텐츠명</td>
				<td><input type="text" size="87" name="contentName"></td>
			</tr>
			<tr>
				<td align="center">후기내용</td>
				<td><textarea rows="5" cols="88" name="reviewContent"></textarea></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" size="87" name="userId"></td>
			</tr>
		</table>
		<br>
		</div>
