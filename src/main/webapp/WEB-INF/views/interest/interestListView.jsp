...
<body id="page-top">
    ...
    <!-- 개인정보 확인 및 수정 영역-->
	<h1 align="center" id="iList">관심 목록</h1>
			<table align="center" id="iTable">
				<tr id="interestTitle">
					<th class="iTitle">게시글 번호</th>
					<th class="iTitle">컨텐츠 번호</th>
					<th class="iTitle">컨텐츠 명</th>
					<th class="iTitle">회원 아이디</th>
					<th class="iTitle">관심 목록 저장일</th>
					<th class="iTitle" align="center">ETC</th>
				</tr>
					<c:forEach items="${iList }" var="interest">
						<tr>
								<td class="iContent">&nbsp;&nbsp;&nbsp;• ${interest.boardNo }</td>
								<td class="iContent">&nbsp;&nbsp;&nbsp;• ${interest.contentNo }</td>
								<td class="iContent">${interest.contentName }</td>
								<td class="iContent">${interest.userId }</td>
								<td class="iContent">${interest.iCreateDate }</td>
								<td class="iContent" id="iContents">
									&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="location.href='/booking/writeView.mayfly?contentNo=${interest.contentNo }'" align="right" id="bookingButton">예약</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button type="button" onclick="location.href='/interest/delete.mayfly?boardNo=${interest.boardNo}'" align="right" id="removeButton">-</button>
						</tr>
					</c:forEach>
				<tr align="center" height="20">
					<td colspan="10">
						<c:forEach var="p" begin="${pi.startNavi }" end="${pi.endNavi }">
							<c:url var="pagination" value="/interest/List.mayfly">
