	...
	<div id="leftAside">
	  ...
	  <div id="main"> 
		...
		<table id="contents-table">
			...
			<c:choose>
   			<c:when test="${cList != null && fn:length(cList) > 0 }">
			<c:forEach items="${cList }" var="contents">
			<c:if test="{i%j == 0}">
			<tr>
				...
				<td id="contents-td">
				<div >
		      		<img src="../resources/img/black_heart.png" alt="하트 사진" width="20px" height="20px"  id="heartBtn" name="heartBtn" onclick="src = '../resources/img/red_heart.png'">
		     	</div>
				<div id="contents-img-div">
					...
					<div><img src="/resources/image/${contents.contentsImg }"
						onclick="javascript:location.href='${cDetail }';" id="contents-img"></div>
				</div>
				<div id="contents-title-div">
					<c:url var="cDetail" value="/contents/Detail.mayfly">
						<c:param name="contentsNo" value="${contents.contentsNo }"></c:param>
					</c:url>
					<div id="title-td"><a href="${cDetail }" id="content-atag">${contents.contentsTitle }</a></div>
				</div>
				<div>
					<div id="detail-div">장소 : ${contents.contentsWriter }<br>기간 : <fmt:formatDate value="${contents.contentsDay}"
							pattern="yyyy-MM-dd" /> ~ <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <fmt:formatDate value="${contents.contentsEnd}"
